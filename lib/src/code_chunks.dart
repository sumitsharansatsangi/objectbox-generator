...
class CodeChunks {
  ...
  static String objectToFB(ModelEntity entity) {
    ...
    final offsetsCode = entity.properties
        .map((ModelProperty p) {
  ...
  /// `as Type`).
  static String readFieldCodeString(
    ModelProperty p,
    String readerCode, {
    String? defaultValue,
    String? castTo,
  ...
  static String objectFromFB(ModelEntity entity) {
    ...
    postLines.addAll(
      entity.backlinks.map((ModelBacklink bl) {
  ...
  static String _metaClass(int i, ModelEntity entity) {
    ...
    for (var r = 0; r < entity.relations.length; r++) {
      ...
      final targetEntityName = entity.model
          .findEntityByUid(rel.targetId.uid)!
          .name;
      fields.add(
        '''
